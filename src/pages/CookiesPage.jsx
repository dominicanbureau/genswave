        ...
        <section className="legal-content">
          ...
          >
            ...
            <div className="legal-section">
              ...
              <p>
                Genswave utiliza cookies para mejorar su experiencia en nuestro sitio web, analizar el tráfico y 
            ...
            <div className="legal-section">
              ...
              <ul>
                ...
                <li>Cookies de Rendimiento: nos ayudan a mejorar el sitio</li>
                <li>Cookies Funcionales: permiten funcionalidad mejorada</li>
                <li>Cookies de Marketing: para mostrar contenido relevante</li>
              </ul>
            </div>
