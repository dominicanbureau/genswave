        ...
        <section className="legal-content">
          ...
          >
            ...
            <div className="legal-section">
              ...
              <ul>
                <li>Información de redes sociales: mensajes de Instagram DM, ID de usuario, nombre de perfil</li>
                <li>Información de contacto: nombre, dirección de email, número de teléfono</li>
                <li>Información de la empresa: nombre de la empresa, cargo, ubicación</li>
                <li>Información del proyecto: detalles sobre sus necesidades y requisitos</li>
            ...
            <div className="legal-section">
              ...
              <ul>
                <li>Consentimiento: cuando nos ha dado permiso explícito</li>
                <li>Contrato: cuando es necesario para cumplir un contrato con usted</li>
                <li>Interés legítimo: para operar y mejorar nuestro negocio</li>
                <li>Obligación legal: cuando la ley lo requiere</li>
              </ul>
            </div>
            ...
            <div className="legal-section">
              ...
              <ul>
                <li>Acceso: solicitar una copia de su información personal</li>
                <li>Rectificación: corregir información inexacta o incompleta</li>
                <li>Eliminación: solicitar la eliminación de su información</li>
                <li>Restricción: limitar cómo usamos su información</li>
                <li>Portabilidad: recibir su información en formato estructurado</li>
                <li>Objeción: oponerse al procesamiento de su información</li>
