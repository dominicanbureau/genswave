...
function ProjectDetail() {
  ...
  useEffect(() => {
    // Solo leer el tema, no controlarlo desde aquí
    const savedTheme = localStorage.getItem('dashboardTheme');
    setIsDarkMode(savedTheme === 'dark');
    
    // Escuchar cambios en el localStorage para sincronizar con el dashboard
    const handleStorageChange = () => {
      const newTheme = localStorage.getItem('dashboardTheme');
  ...
  return (
    <div className={`project-detail-page ${isDarkMode ? 'dark' : 'light'}`}>
      <motion.button
        className="back-btn"
